defmodule Grep do
  ...
  def grep(pattern, flags, files) do
   # pattern = getPatternFlagV(pattern, flags)
...
#defp getPatternFlagV(pattern, flags) do
 #   if "-v" in flags do 
 #      "[^(" <> pattern <> ")]"
 #   else
 #      pattern
 ...
 defp getPattern(pattern, flags) do
  ...
  defp getRego(pattern, flags) do
     cond do
       ...
       #  "-v" in flags ->   Regex.compile!(pattern)
