defmodule GottaSnatchEmAll do
  ...
  def total_cards(collections) do
     call = Enum.reduce(collections, Enum.at(collections, 0), fn(el, acc) -> MapSet.new(MapSet.to_list(el) ++ MapSet.to_list(acc) )  end)
     MapSet.size(call)
  end
  ...
  def split_shiny_cards(collection) do
     ...
     {MapSet.to_list(a), MapSet.to_list(b)}
  end
end
